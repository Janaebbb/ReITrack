...
from trackers import ReITrack as tracker_module
from trackers.ReITrack.reidentification_tracker import ReITracker as Tracker
...
def get_main_args():
    ...
    ###
    utils.gen_exp_name(args, parser.exp_name_it_list)
    args.seed = 6
