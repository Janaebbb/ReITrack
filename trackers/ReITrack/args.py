...
class Args:
    def __init__(self):
        self.parser = argparse.ArgumentParser("ReITrack parameters")
        ...
        self.parser.add_argument("--aw_off", action="store_true")
        ...
        self.parser.add_argument("--OSFormer", action='store_true')
        self.parser.add_argument("--OAW", action='store_true', help='occlusion-aware adaptive weighted association')

        self.parser.exp_name_it_list = ['OSFormer', 'OAW']
